...
text_coulor = (255, 255, 255)
button_coulor = (0, 0, 170)
button_over_coulor = (255, 50, 50)
...
button_text = button_font.render('Quit', True, text_coulor)
...
while not game_over:
    ...
    if (button_rect[0] <= x <= button_rect[0] + button_rect[2] and
            button_rect[1] <= y <= button_rect[1] + button_rect[3]):
        pygame.draw.rect(screen, button_over_coulor, button_rect)
    else:
        pygame.draw.rect(screen, button_coulor, button_rect)
